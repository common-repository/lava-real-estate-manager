<?php
class Lava_Realestate_Recents extends WP_Widget
{
	static $load_script;
									...
									<a href="<?php echo get_permalink(); ?>">
										...
										else
										{
											printf(
												...
												, apply_filters( 'lava_realestate_listing_featured_no_image', lava_realestate()->image_url . 'no-image.png' )
											);
										} ?>
									</a>
								</span>
							...
							<div class="lava-recent-widget-content text-content">
								<?php
									printf('<h3><a href="%s">%s</a></h3><a href="%s"><span>%s</span></a>'
										, get_permalink()
										, substr(get_the_title(), 0, 20).(strlen(get_the_title()) > 20 ? '...' : '')
										, get_permalink()
										, substr(get_the_excerpt(), 0, 20 ).(strlen(get_the_excerpt()) > 20 ? '...' : '')
									); ?>
