<?php
class Lava_RealEstate_Manager_Addons
{

	const DEBUG_MODE = false;

	const urlAPI = 'www.lava-code.com/real-estate/';
	...
	const AddonsTransient = 'lava_realestate_lastest_addons_cache';
	const AddonsSchedule = 'lava_realestate_version_check_schedule';
	...
	public function __construct()
	{
		...
		add_action( 'lava_realestate_manager_admin_addons_after', Array( $this, 'addons_page' ) );
